...
/* ---------
    Weaver iFrame fixer
*/
function atw_fixVideo(myframe,vert)
{
...
jQuery(window).load(atw_RunOnLoad);

//Every resize of window
jQuery(window).resize(atw_RunOnResize);

function atw_RunOnReady() {
   atw_onResize();
}

function atw_RunOnLoad() {

}

function atw_RunOnResize() {
   atw_onResize();
}
